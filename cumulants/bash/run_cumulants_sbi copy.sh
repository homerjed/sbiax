...
for i in {0..2}; do
    ...
    python cumulants_multi_z.py --seed $id --sbi_type "nle" --linearised --order_idx $order_idx_args --compression "linear" --bulk_or_tails "bulk" --no-freeze-parameters
    ...
    echo ">>Sampling multi-z with non-linear datavectors..."
    python cumulants_multi_z.py --seed $id --sbi_type "nle" --compression "linear" --no-linearised --pre-train --n_linear_sims 10000 --order_idx $order_idx_args --bulk_or_tails "bulk" --no-freeze-parameters
    echo ">>Sampling multi-z with non-linear datavectors... Completed."
    ...
    # Sample multi-z posteriors with linear datavectors
    echo ">>Sampling multi-z with linear datavectors..."
    python cumulants_multi_z.py --seed $id --sbi_type "nle" --linearised --order_idx $order_idx_args --compression "linear" --bulk_or_tails "bulk"
    echo ">>Sampling multi-z with linear datavectors... Completed."
    ...
    # Sample multi-z posteriors with non-linear datavectors (pre-train)
    echo ">>Sampling multi-z with non-linear datavectors..."
    python cumulants_multi_z.py --seed $id --sbi_type "nle" --compression "linear" --no-linearised --pre-train --n_linear_sims 10000 --order_idx $order_idx_args --bulk_or_tails "bulk"
    echo ">>Sampling multi-z with non-linear datavectors... Completed."
