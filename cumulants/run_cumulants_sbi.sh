...
for i in {0..2}; do
    ...
    for z in 0.0 0.5 1.0; do
        ...
        python cumulants_sbi.py --seed $id --sbi_type "nle" --compression "linear" --linearised --order_idx $order_idx_args --redshift $z --no-use-tqdm
        ...
        python cumulants_sbi.py --seed $id --sbi_type "nle" --compression "linear" --no-linearised --pre-train --order_idx $order_idx_args --redshift $z --no-use-tqdm
