...
def make_step(
    ...
    *,
    ...
    Args:
        ...
        replicated_sharding: An optional `NamedSharding` object for distributing computations across devices. Defaults to `None`.
...
def train_ensemble(
    ...
    # Set CNF non-exact log-likelihoods 
    for n, nde in enumerate(ensemble.ndes):
